...
# Crear objetos Diario y lista de objetos
...
# Cantidad actual de listas
todos_antes = len(todos)
belicas_antes = len(belicas)

# Extracción de datos nuevos y unión con anteriores
dfs = {"todos" : todos}
...
# Información sobre nuevos datos y errores
...
# Limpieza de tablas y ordenamiento por fecha
...
# Tabla nueva con resumen de datos
